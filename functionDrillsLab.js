...
const jsNinja = () => {
  return console.log("I am a Javascript ninja!");
};
...
let nameGreeting = nameCheck("chad");
...
function faveColorFinder(color) {
  ...
  switch (color) {
    case "red":
      colorChoice = "red is a great color";
      break;
    case "green":
      colorChoice = "green is a solid favorite color";
      break;
    case "black":
      colorChoice = "so trendy";
      break;
    default:
      colorChoice = "you need to evaluate your favorite color choice";
  }
  return colorChoice;
}
...
let oddChecker = console.log(thatsOdd(2));
////////////////// PROBLEM 14 ////////////////////
...
console.log(bestMovie("surfs up"));
////////////////// PROBLEM 15 ////////////////////
...
let arrayEvaluator = console.log(bigOrSmall());
////////////////// PROBLEM 16 ////////////////////
let contestants = [
  "Katniss",
  "Peeta",
...
const theEliminator = (contestants, loser) => {
  let updated = contestants.indexOf(loser);

  if (updated !== -1) {
    contestants.splice(updated, 1);
  }

  return contestants;
};

let contestantnew = theEliminator(contestants, loser);
console.log(contestantnew);
////////////////// PROBLEM 17 ////////////////////
...
const emailCheck = (email) => {
  ...
  // return email.includes("@") ? "email verified" : "must provide email address"
};

console.log(emailCheck("mcpaunga@gmail.swag"));
////////////////// PROBLEM 19 ////////////////////
/*
...
const frogsc = (gold) => {
  let frogs = 3;
  chocolate = gold / frogs;
  return chocolate;
};

console.log(frogsc(6));
////////////////// PROBLEM 20 ////////////////////
/*
...
//CODE HERE
const totalFrogs2 = (gold) => {
  let frogs = 3;
  chocolate = gold / frogs;
  return Math.trunc(chocolate);
};

console.log(totalFrogs2(4));
////////////////// PROBLEM 21 ////////////////////
